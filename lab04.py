...
#lab04-Q3
#Increase Monster's Combat Strenght by it's power, without going over 6
m_combat_strength = min(6, m_combat_strength + monster_powers[power_roll])
print("The monster's combat strength is " + str(m_combat_strength) + "using the" + power_roll + " power roll")
